#ifndef __ARM_COMPUTE_NEABMINPUTTRANSPOSEKERNEL_H__
#define __ARM_COMPUTE_NEABMINPUTTRANSPOSEKERNEL_H__
...
class NEABMInputTransposeKernel : public INEKernel
{
public:
    const char *name() const override
    {
        return "NEABMInputTransposeKernel";
    }
    /** Default constructor */
    NEABMInputTransposeKernel();
    /** Prevent instances of this class from being copied (As this class contains pointers) */
    NEABMInputTransposeKernel(const NEABMInputTransposeKernel &) = delete;
    /** Prevent instances of this class from being copied (As this class contains pointers) */
    NEABMInputTransposeKernel &operator=(const NEABMInputTransposeKernel &) = delete;
    /** Allow instances of this class to be moved */
    NEABMInputTransposeKernel(NEABMInputTransposeKernel &&) = default;
    /** Allow instances of this class to be moved */
    NEABMInputTransposeKernel &operator=(NEABMInputTransposeKernel &&) = default;
    /** Default destructor */
    ~NEABMInputTransposeKernel() = default;
